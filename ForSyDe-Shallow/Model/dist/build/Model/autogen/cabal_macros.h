...
/* package ForSyDe-Shallow-Model-0.1.0.0 */
#ifndef VERSION_ForSyDe_Shallow_Model
#define VERSION_ForSyDe_Shallow_Model "0.1.0.0"
#endif /* VERSION_ForSyDe_Shallow_Model */
#ifndef MIN_VERSION_ForSyDe_Shallow_Model
#define MIN_VERSION_ForSyDe_Shallow_Model(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ForSyDe_Shallow_Model */
...
/* package forsyde-shallow-3.4.0.0 */
#ifndef VERSION_forsyde_shallow
#define VERSION_forsyde_shallow "3.4.0.0"
#endif /* VERSION_forsyde_shallow */
#ifndef MIN_VERSION_forsyde_shallow
#define MIN_VERSION_forsyde_shallow(major1,major2,minor) (\
  (major1) <  3 || \
  (major1) == 3 && (major2) <  4 || \
  (major1) == 3 && (major2) == 4 && (minor) <= 0)
#endif /* MIN_VERSION_forsyde_shallow */
...
#define CURRENT_COMPONENT_ID "ForSyDe-Shallow-Model-0.1.0.0-AKWwXR7fkh6BabucTNfvfy-Model"
